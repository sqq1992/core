...
(function (app) {
    ...
    model._initRequestParams = function (requestParams) {
        ...
        if (!requestParams.campaignId) {
            throw new window.Error("API.adGroup.postSpreadStatus: *缺少参数：campaignId");
        }
        if (!requestParams.adgroupId) {
            throw new window.Error("API.adGroup.postSpreadStatus: *缺少参数：adgroupId");
        }
        if (!requestParams.onlineStatus) {
            throw new window.Error("API.adGroup.postSpreadStatus: *缺少参数：onlineStatus");
        }
    ...
    app.API.adGroup.postSpreadStatus = model.entry;
