    ...
    Module.prototype = {
        ...
        data: function () {
            ...
            getUser(function (data) {
                _this.option.versionNum = data.versionNum;
                ...
                if (_this.checkSession()) {
                    utils.concurrent({
                        ...
                        complete: function (json) {
                            var data = json.data,
                                o = data.briefing.data.optimizeReportGetResponse.optimizeReport;
                            if (o) {
                                _this.option.data = data.briefing.data.optimizeReportGetResponse.optimizeReport;
                                _this.option.data.optimizeTime = moment(_this.option.data.optimizeTime).format("YYYY-MM-DD");
                                _this.option.data.modifyPriceWordCount = +_this.option.data.decWordCount + +_this.option.data.incWordCount;
                                _this.option.data.autoGrabStatus = data.ranking.autoGrabStatus;
                            } else {
                                _this.option.error = data.briefing.data.optimizeReportGetResponse.subMsg;
                            }
                            $('#' + _this.option.id).replaceWith(_this.getDom());
