    ...
    app.control = {
        updateModules: function (route, hashSearch, diffPath) {
            ...
            app.load.use(_render, function () {
                if (app.load.beforePageInit) {
                    app.load.beforePageInit(_renderHandler.bind(this, arguments));
                } else {
...
(function (app) {
    ...
    app.route = {
        ...
        check: function (f) {
            ...
            // 加入百度统计
            if (app.url.getPathname() == '/index.html') {
                _hmt.push(['_trackPageview', '/' + f.split('?')[0]]);
            }
            return this;
        },
        /**
...
(function (app) {
    ...
    app.utils.ajaxGroup = function (config) {
        // 缓存json数据
        var obj = {},
     ...
     */
    app.utils.mathAdd = function (arg1, arg2) {
        var firstArg,
            lastArg,
            differ,
            dm,
    ...
    // 除
    app.utils.mathDiv = function (arg1, arg2) {
        var firstArg,
            lastArg,
            r1,
            r2;
    ...
    // 乘
    app.utils.mathMul = function (arg1, arg2) {
        var m = 0,
            firstArg,
            lastArg;
    ...
    // 减
    app.utils.mathSub = function (arg1, arg2) {
        var firstArg,
            lastArg,
            differ,
            m;
